...
if [[ BUILDS_FINISHED -eq 1 ]]; then
    ...
    curl -X POST -H "Authorization: db85d8fb-da63-4d77-950e-3dffcd8ce115" -H "Content-Type: application/json" -d '{"job": "'$TREE_NAME'", "kernel": "'$GIT_DESCRIBE'", "build_report": 1, "send_to": ["gabriele.paoloni@huawei.com", "charles.chenxin@huawei.com", "xavier.huwei@huawei.com", "majun258@huawei.com", "wangzhou1@hisilicon.com", "xuwei5@hisilicon.com", "liwenchang@hisilicon.com", "tangchaofei@huawei.com", "wanghuiqiang@huawei.com", "xuzaibo@huawei.com", "yuanzhichang@hisilicon.com", "yisen.zhuang@huawei.com", "zhangjukuo@huawei.com", "anurup.m@huawei.com", "john.gary@huawei.com", "shiju.jose@huawei.com", "dongyingjie@hisilicon.com"], "send_cc": ["yimin@huawei.com", "liguozhu@hisilicon.com", "zhaojunhua@hisilicon.com", "lixiaoping3@huawei.com", "z.liuxinliang@hisilicon.com", "kong.kongxinwei@hisilicon.com"], "format": ["txt", "html"], "delay": 10}' http://192.168.3.100:8888/send
fi
